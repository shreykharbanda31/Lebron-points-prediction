...
if app_page == 'Data Exploration':
    ...
    if st.button("Show table key"):
        ...
        st.write("""
        - Date: The game’s date might capture trends like fatigue, rest days, or performance fluctuations over time (e.g., based on the phase of the season or back-to-back games).
